...
class InvestorSignUpScreenView extends GetView<InvestorSignUpScreenController> {
  const InvestorSignUpScreenView({super.key});
          ...
          SingleChildScrollView(
            ...
            child: Column(
              ...
              children: [
                ...
                CustomTextField(
                  styleoftextfeild: TextStyle(color: Colors.white),
                  HintText: "Enter Refer Id of Broker (Optinal)",
                  Radius: 10,
                  TextStyleForHintText: TextStyle(
                      fontSize: 12.sp,
                      fontWeight: FontWeight.w400,
                ...
                myButton(
                  ...
                  onTap: () {controller.validateAndCreateAccount();},
